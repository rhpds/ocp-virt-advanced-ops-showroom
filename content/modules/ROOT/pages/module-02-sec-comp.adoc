...
+
NOTE: This process can take quite a bit of time to complete depending on how busy the cluster currently is, and how many nodes there are to remediate. You can safely move along to the next section while it proceeds in the background.
+
...
+
image::module-02-sec-comp/20-compscan_results.png[title="Compliance Scan Results", link=self, window=blank, width=100%]
...
+
image::module-02-sec-comp/36-auditor1_admin_view.png[title="Auditor 1 Admin View", link=self, window=blank, width=100%]+
...
+
image::module-02-sec-comp/37-auditor1_vm_view.png[title="Auditor 1 VM View", link=self, window=blank, width=100%]
+
...
+
image::module-02-sec-comp/38-auditor1_database_readonly.png[title="Auditor 1 Database ReadOnly", link=self, window=blank, width=100%]
+
