...
+
image::module-02-sec-comp/33-oauth_reconfig.png[title="OAuth Reconfiguration", link=self, window=blank, width=100%]
+
...
+
image::module-02-sec-comp/34-oauth_reconfig_2.png[title="OAuth Reconfiguration Progressing", link=self, window=blank, width=100%]
+
image::module-02-sec-comp/35-oauth_reconfig_3.png[title="OAuth Reconfiguration Complete", link=self, window=blank, width=100%]
...
+
image::module-02-sec-comp/36-logout_openshift.png[title="Log Out OpenShift", link=self, window=blank, width=100%]
+
. There is now an option to login with the *auditor_login* identity provider on the main OpenShift page.
+
image::module-02-sec-comp/37-login_openshift.png[title="Log In OpenShift", link=self, window=blank, width=100%]
+
. Click on *auditor_login* and when presented use the following username and password combination:
  * *Username:* auditor1
  * *Password:* auditor1pass!
+
image::module-02-sec-comp/38-auditor1_login.png[title="Auditor 1 Login", link=self, window=blank, width=100%]
+
...
+
image::module-02-sec-comp/39-auditor1_admin_view.png[title="Auditor 1 Admin View", link=self, window=blank, width=100%]+
...
+
image::module-02-sec-comp/40-auditor1_vm_view.png[title="Auditor 1 VM View", link=self, window=blank, width=100%]
+
...
+
image::module-02-sec-comp/41-auditor1_database_readonly.png[title="Auditor 1 Database ReadOnly", link=self, window=blank, width=100%]
+
