...
Dynamic inventories allow Ansible Automation Platform (AAP) to automatically fetch and update the list of systems from external sources, eliminating the need for manual management.
...
NOTE: Make a note of this snapshot name, as it will be used in the next section to restore the snapshot.
