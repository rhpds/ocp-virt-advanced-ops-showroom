...
image::module-04-virt-automation/02-aap_login.png[title="AAP Login", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/03-auto_infra_inv.png[title="Automation Execution, Infrastucture, Inventories", link=self, window=blank, width=100%]
+
. Click the *Create inventory* drop-down box and select the *Create inventory* option.
+
image::module-04-virt-automation/04-create_inventory_dropdown.png[title="Create Inventory Dropdown", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/05-create_inventory.png[title="Create Inventory", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/06-sources_tab.png[title="Sources Tab", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/07-create_inventory_source.png[title="Create Inventory Source", link=self, window=blank, width=100%]

===  Update the Inventory
. Click the *Launch Inventory Update* button in the top-right corner to start inventory collection.
+
image::module-04-virt-automation/08-update_inventory.png[title="Update Inventory", link=self, window=blank, width=100%]
+
. Wait for the *Last Job Status* to show *Success*.
+
image::module-04-virt-automation/09-job_status_success.png[title="Job Status Success", link=self, window=blank, width=100%]
+
. Click on the tab for *Back to Inventory Sources*.
+
image::module-04-virt-automation/10-back_to_inventory_sources.png[title="Back to Inventory Sources", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/11-verify_hosts.png[title="Verify Hosts", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/12-run_command.png[title="Run Command", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/13-review_run_command.png[title="Review Run Command", link=self, window=blank, width=100%]
+
...
----
+
image::module-04-virt-automation/14-ping_success.png[title="Ping Success", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/15-vm_inventory_openshift.png[title="Virtual Machines Running on OpenShift", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/55a-running_vms.png[title="Running AAP VMs", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/56-create_job_template.png[title="Create Job Template", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/57-stop_vms_template.png[title="Stop VMs Template", link=self, window=blank, width=100%]
+
. Once the *Stop VMs* Job Template is created, select the *Launch template* button on the top right corner to run the job.
+
image::module-04-virt-automation/58-launch_stop_vms.png[title="Launch Stop VMs Template", link=self, window=blank, width=100%]
+
. The job will start running, and once it is successful you will see changes displayed in yellow.
+
image::module-04-virt-automation/59-successful_job.png[title="Successful Job", link=self, window=blank, width=100%]
+
. Return to the OpenShift console to see that the virtual machines in the *vms-aap-day2* project have all now stopped.
+
image::module-04-virt-automation/60-stopped_vms.png[title="Stopped VMs", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/61-create_job_template.png[title="Stop VMs Template", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/62-create_patch_template.png[title="Create Patch Template", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/63-patch_vm.png[title="Patch VM", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/64-patch_complete.png[title="Patching Complete", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/65-patch_details.png[title="Patch Details", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/66-vm_details.png[title="VM Details", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/67-create_template.png[title="Create Job Template", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/68-create_hotadd_template.png[title="Create HotAdd Template", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/69-hotadd_template_success.png[title="HotAdd Template Success", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/70-vm_modified_instancetype.png[title="VM InstanceType Modified ", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/71-create-snapshot.png[title="Create Snapshot Template", link=self, window=blank, width=100%]
+
...
+
image::module-04-virt-automation/72-ocp-snapshot-details.png[title="Snapshot Details", link=self, window=blank, width=100%]
...
. Click *Create Job Template*.
+
image::module-04-virt-automation/73-restore-snapshot.png[title="Restore Snapshot Template", link=self, window=blank, width=100%]
...
+
image::module-04-virt-automation/74-ocp-restore-snapshot-details.png[title="Restore Snapshot Details", link=self, window=blank, width=100%]

== Summary

In this module you have spent a day in the life of an OpenShift Virtualization administrator making use of Ansible Automation Platform to automate a number of administrative tasks that staff experience often on a day-to-day basis.
